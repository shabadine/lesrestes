...
12. [RECHERCHE AVANCÉE ET PAGINATION](#etape-11--recherche-avancee-et-pagination)
13. [LOADING STATES ET ANIMATIONS CSS](#etape-12--loading-states-et-animations-css)
14. [AMÉLIORATION VISUELLE ET MESSAGES FLASH](#etape-13--amelioration-visuelle-et-messages-flash)
15. [LOADING STATES ET ANIMATIONS CSS (suite)](#etape-14--loading-states-et-animations-css)
16. [MESSAGES DE FEEDBACK AMÉLIORÉS](#etape-15--messages-de-feedback-ameliores)
17. [FINALISATION DE L'INTERFACE SELON LE WIREFRAME](#etape-16--finalisation-de-l-interface-selon-le-wireframe)
18. [CORRECTIONS DE LA RECHERCHE ET COHÉRENCE VISUELLE](#etape-17--corrections-de-la-recherche-et-coherence-visuelle)
19. [PAGE DÉTAIL RECETTE SELON WIREFRAME 03](#etape-18--page-detail-recette-selon-wireframe-03)
20. [ADMINISTRATION DES INGRÉDIENTS](#etape-19--administration-des-ingredients)
21. [PAGES LÉGALES OBLIGATOIRES](#etape-20--pages-legales-obligatoires)
22. [PAGE 404 PERSONNALISÉE](#etape-21--page-404-personnalisee)
23. [RESPONSIVE DESIGN COMPLET](#etape-22--responsive-design-complet)
24. [AUDIT ACCESSIBILITÉ RGAA - HOMEPAGE](#etape-23--audit-accessibilite-rgaa-homepage)
25. [TESTS UNITAIRES PHPUNIT](#etape-24--tests-unitaires-phpunit)
...
| #   | Problème          | Élément                                        |
| --- | ----------------- | ---------------------------------------------- |
| 1   | Boutons sans nom  | Boutons supprimer ingrédient                   |
| 2   | Contraste couleur | `.btn-outline-primary` "Ajouter un ingrédient" |
| 3   | Hiérarchie titres | h2 → h5/h6 (saute niveaux)                     |
| 4   | Touch targets     | Select unité trop petit (21px < 24px)          |

**Corrections appliquées** :

#### Fichier `templates/recette/edit.html.twig`

-   `h2` → `h1` pour titre principal
-   `h6` → `<h2 class="h6">` pour "Actions"
-   `aria-hidden="true"` sur icônes

#### Fichier `templates/recette/partials/_form_basic_fields.html.twig`

-   Label image avec `for="recette_imageFile_file"`
-   `aria-required="true"` sur champ nom

#### Fichier `templates/recette/partials/_form_ingredients.html.twig`

-   `label` → `<h2 class="h5">` pour "Ingrédients"
-   `aria-label="Supprimer cet ingrédient"` sur boutons
-   `aria-hidden="true"` sur icônes

#### Fichier `templates/recette/partials/_form_steps.html.twig`

-   `label` → `<h2 class="h5">` pour "Étapes"
-   `aria-labelledby` sur textarea

#### Fichier `public/css/utilities.css`

-   `.btn-outline-primary` : couleur `#0a58ca` pour contraste 4.5:1
